...
// keycodes
const int keyCodeSize = 7;
const array<int, keyCodeSize> glfwKeyCodes = {{GLFW_KEY_ESC, GLFW_KEY_UP, GLFW_KEY_DOWN, GLFW_KEY_LEFT, GLFW_KEY_RIGHT, GLFW_KEY_KP_SUBTRACT, GLFW_KEY_KP_ADD}};
const array<KeyCode, keyCodeSize> enumKeyCodes = {{KEY_ESC, KEY_UP, KEY_DOWN, KEY_LEFT, KEY_RIGHT, KEY_MINUS, KEY_PLUS}};
